                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a href="{{route('pod.edit', ['pod' => $pod_transaction])}}" class="btn btn-outline-warning">
                                    ...
                                    <a href="{{route('pod.delete', ['pod' => $pod_transaction])}}"  onclick="return confirm('Are you sure you want to delete this file?')" class="btn btn-outline-danger">
